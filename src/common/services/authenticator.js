angular.module('services.Authenticator', []).factory('Authenticator',
        ['Base64', '$cookieStore', '$http', 'MessageFactory', '$rootScope', function (Base64, $cookieStore, $http, MessageFactory, $rootScope)
        {
            ...
            return {
                login: function (email, password, callback)
                {
                    ...
                    $http.post("/api/auth/token", null, {withCredentials: true}).success(function (data)
                    {
                        setupAuthorizatoinHeader(data);
                        MessageFactory.info("Welcome to ngMockE2Esample!");
                ...
                setToken: function (token)
                {
                    ...
                    $rootScope.$broadcast("ngMockE2Esample:authentication-token-set");
                }
            };
        }]);

angular.module('services.Authenticator').factory('Base64', function ()
{
